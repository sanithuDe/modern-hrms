...
export async function updateShiftAssignmentController(
  request: AuthenticatedRequest,
  response: Response,
  next: NextFunction,
): Promise<void> {
  try {
    const params =
      assignmentIdParamsSchema.parse(
        request.params,
      );

    const input =
      updateShiftAssignmentSchema.parse(
        request.body,
      );
...
export async function deleteShiftAssignmentController(
  request: AuthenticatedRequest,
  response: Response,
  next: NextFunction,
): Promise<void> {
