...
export default function DepartmentsPage() {
    ...
    return departments.filter((department) => {
      ...
      return (
        department.name
          .toLowerCase()
          .includes(keyword) ||
        departmentDescription.includes(keyword)
      );
    });
  }, [departments, search]);
  ...
  async function handleDeleteConfirmed() {
    ...
    try {
      ...
      setSuccess(
        `"${departmentName}" was deleted successfully.`,
      );
    } catch (requestError: unknown) {
      setError(
        getRequestErrorMessage(
          ...
          <div className="mt-8 grid gap-8 xl:grid-cols-[380px_1fr]">
            ...
            <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
              <div className="flex flex-col justify-between gap-4 border-b border-slate-200 p-5 md:flex-row md:items-center">
                <div className="flex w-full max-w-md items-center gap-2 rounded-xl border border-slate-300 px-4 py-3 focus-within:border-slate-900 focus-within:ring-2 focus-within:ring-slate-200">
                  <Search
                    size={18}
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Update the department name and
                  description.
                </p>
              </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-slate-950/60 p-4 backdrop-blur-sm">
          <div className="w-full max-w-md overflow-hidden rounded-3xl border border-white/20 bg-white shadow-2xl">
            <div className="bg-gradient-to-br from-red-50 via-white to-orange-50 p-7">
              <div className="flex items-start justify-between gap-4">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-red-100 shadow-sm">
                  <Trash2
                    size={27}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-5 text-amber-800">
                      ...
                      employees or positions cannot be
                      deleted.
                    </p>
                  </div>
                </div>
            ...
            <div className="flex flex-col-reverse gap-3 border-t border-slate-200 bg-white p-5 sm:flex-row sm:justify-end">
              ...
              <button
                ...
                disabled={Boolean(deletingId)}
                className="flex items-center justify-center gap-2 rounded-xl bg-red-600 px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-red-600/20 transition hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
                <Trash2 size={17} />
